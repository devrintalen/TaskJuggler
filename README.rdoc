= Interactive Gantt Charts for TaskJuggler

TaskJuggler is a great tool. I learned about it when I was looking for
something that I could run on linux. Being able to edit my project
files as text is what I prefer, but the chart visualization definitely
lacks compared to the GUI tools out there.
