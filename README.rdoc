...
<em>(The interactive Gantt chart, showing tasks, dependency arrows, and resource
...
<em>(Panning and zooming through a multi-month project schedule.)</em>
...
<em>(Zooming from year scale down to day scale, showing automatic level-of-detail
transitions.)</em>
...
<em>(Hovering over a task bar highlights the bar and its dependency arrows.)</em>
...
<em>(Tooltip popup on a task bar showing scheduling details.)</em>
