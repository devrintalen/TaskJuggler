...
_(The interactive Gantt chart, showing tasks, dependency arrows, and resource
load. Add +formats htmljs+ to any taskreport or resourcereport to get this.)_
...
_(Panning and zooming through a multi-month project schedule.)_
...
_(Zooming from year scale down to day scale, showing automatic level-of-detail
transitions.)_
...
_(Hovering over a task bar highlights the bar and its dependency arrows.)_
...
_(Tooltip popup on a task bar showing scheduling details.)_
